...
export default function LandingV2() {
      ...
      setProgress((prev) => {
        if (prev >= 100) {
          if (mountedRef.current) {
            setActiveCard((current) => (current + 1) % 4) // 4 feature cards
          }
          return 0
        }
  ...
  return (
    <div className="w-full hw-page relative bg-[#faf8f5] overflow-x-hidden flex flex-col justify-start items-center">
      <div className="relative flex flex-col justify-start items-center w-full">
        {/* Main container */}
        <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start hw-page">
          {/* Left vertical line */}
              ...
              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-[#faf8f5] backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
                <div className="flex justify-center items-center gap-4">
                  ...
                  <div className="hidden sm:flex flex-row gap-2 sm:gap-3 md:gap-4 lg:gap-4">
                    <button className="text-[rgba(49,45,43,0.80)] text-xs md:text-[13px] font-medium hover:text-[#2563EB] transition-colors">
                      Features
                    </button>
                    <button className="text-[rgba(49,45,43,0.80)] text-xs md:text-[13px] font-medium hover:text-[#2563EB] transition-colors">
                      Pricing
