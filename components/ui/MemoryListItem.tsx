...
export function MemoryListItem({
  ...
  const age = story.year_of_event && story.user_birth_year
  ...
  return (
    ...
    >
      ...
      >
        <div className="title text-[17px] md:text-[18px] font-semibold tracking-tight
        ...
        <div className="badges mt-1.5 hidden sm:flex items-center gap-2">
          {story.show_in_timeline && (
            <span className="pill text-[11px] px-2 py-0.5 rounded-full
      ...
      <div className="actions flex items-center gap-2">
        ...
        <div className="relative group/menu">
          ...
          {/* Dropdown Menu */}
          <div className="absolute right-0 top-full mt-2 w-48 py-2 bg-white rounded-xl
