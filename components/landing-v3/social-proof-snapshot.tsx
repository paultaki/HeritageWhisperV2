        ...
        <div className="bg-gradient-to-br from-blue-50 to-orange-50 rounded-3xl p-8 md:p-12 shadow-xl border border-stone-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="md:col-span-1">
              <div className="aspect-square bg-gradient-to-br from-stone-200 to-stone-300 rounded-2xl shadow-lg overflow-hidden flex items-center justify-center border border-stone-300">
                <div className="text-center px-4">
                  <p className="text-gray-600 text-sm font-medium">
                    Photo: Elderly woman<br />
                    with phone, smiling
                  </p>
                </div>
              </div>
