    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[60] w-[90%] max-w-sm rounded-2xl shadow-2xl overflow-hidden bg-white/95 backdrop-blur-xl border border-white/30"
        >
          {/* User Info */}
          {user && (
