...
import { MultiPhotoUploader, StoryPhoto } from "@/components/MultiPhotoUploader";
...
export function StoryReviewCard({
  ...
  // Handle photos change from MultiPhotoUploader
  const handlePhotosChange = (photos: StoryPhoto[]) => {
    onUpdate({ photos });
  };
  ...
  return (
    ...
    >
      ...
      {/* Photo upload with zoom/pan editor */}
      <div>
