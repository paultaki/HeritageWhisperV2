  ...
  return (
    <nav
      ...
      className={cn(
        ...
        // taupe tint based on brand color #866C7A - DARKER for consistent visibility
        "bg-[linear-gradient(180deg,rgba(255,255,255,0.12),rgba(255,255,255,0.06))]",
        "bg-[rgba(134,108,122,0.32)]", // Increased from 0.18 to 0.32 for darker, more consistent background
        "relative",
