...
export function generateGhostPrompts(birthYear: number): GhostPrompt[] {
  ...
  prompts.push({
    ...
    prompt:
      "What stories have you been told about the day you were born? What was happening in your family and the world at that time?",
    year: birthYear,
    age: 0,
    isGhost: true,
    icon: "👶",
  ...
  if (birthYear + 6 <= currentYear) {
    prompts.push({
      ...
      prompt:
        "Do you remember your first day of school? What did you wear? Who took you? How did you feel walking into that classroom?",
      year: birthYear + 6,
      age: 6,
      isGhost: true,
      icon: "🎒",
  ...
  if (birthYear + 16 <= currentYear) {
    prompts.push({
      ...
      title: "My First Car",
      prompt:
        "Tell us about your first car. How did you get it? Where was the first place you drove? What did that freedom feel like?",
      year: birthYear + 16,
      age: 16,
      isGhost: true,
      icon: "🚗",
  ...
  if (birthYear + 25 <= currentYear) {
    prompts.push({
      ...
      prompt:
        "When did you first fall in love? How did you meet? What made them special? What do you remember most about those early days?",
      year: birthYear + 25,
      age: 25,
      isGhost: true,
      icon: "❤️",
  ...
  if (userAge >= 35) {
    ...
    if (birthYear <= 1955) {
      ...
      eventPrompt =
        "Where were you when humans first walked on the moon? How did you watch it? What did it mean to you?";
    } else if (birthYear <= 1965) {
      // Fall of Berlin Wall (1989)
      eventYear = 1989;
      eventTitle = "The Fall of the Berlin Wall";
      eventPrompt =
        "What do you remember about the fall of the Berlin Wall? How did the end of the Cold War affect your life?";
    } else if (birthYear <= 1975) {
      // 9/11 (2001)
      eventYear = 2001;
      eventTitle = "September 11th";
      eventPrompt =
        "Where were you on September 11, 2001? How did you first hear the news? How did that day change things?";
    } else {
      // COVID-19 (2020)
      eventYear = 2020;
      eventTitle = "The Pandemic";
      eventPrompt =
        "What do you remember about the start of the COVID-19 pandemic? How did your life change? What surprised you most?";
    }
