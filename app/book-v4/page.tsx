    ...
    <div className="relative mx-auto" style={{ 
      ...
      <button
        ...
        style={{
          ...
          boxShadow: "0 25px 80px rgba(0,0,0,0.7), inset 0 1px 0 rgba(139,111,71,0.15), inset 0 -1px 0 rgba(0,0,0,0.5)"
        }}
        aria-label="Open book"
      >
        {/* Leather grain texture */}
        <div 
          className="absolute inset-0 opacity-40 rounded-[24px] pointer-events-none"
          style={{
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center">
          <h1 
            ...
            style={{ 
              ...
              color: "#d4af87",
              textShadow: "0 2px 4px rgba(0,0,0,0.8), 0 -1px 1px rgba(255,255,255,0.1)",
              fontWeight: 600,
            }}
          >
            {userName}&apos;s Story
          ...
          <p className="text-xl md:text-2xl font-medium" style={{ color: "#c4a87a", textShadow: "0 1px 3px rgba(0,0,0,0.6)" }}>
        ...
        {/* Decorative embossed corner elements */}
        <div className="absolute top-6 left-6 w-12 h-12 border-l-2 border-t-2 rounded-tl-lg" style={{ borderColor: "rgba(212, 175, 135, 0.2)", filter: "drop-shadow(0 1px 1px rgba(0,0,0,0.5))" }}></div>
        <div className="absolute top-6 right-6 w-12 h-12 border-r-2 border-t-2 rounded-tr-lg" style={{ borderColor: "rgba(212, 175, 135, 0.2)", filter: "drop-shadow(0 1px 1px rgba(0,0,0,0.5))" }}></div>
        <div className="absolute bottom-6 left-6 w-12 h-12 border-l-2 border-b-2 rounded-bl-lg" style={{ borderColor: "rgba(212, 175, 135, 0.2)", filter: "drop-shadow(0 1px 1px rgba(0,0,0,0.5))" }}></div>
        <div className="absolute bottom-6 right-6 w-12 h-12 border-r-2 border-b-2 rounded-br-lg" style={{ borderColor: "rgba(212, 175, 135, 0.2)", filter: "drop-shadow(0 1px 1px rgba(0,0,0,0.5))" }}></div>
      </button>
    </div>
  );
}
