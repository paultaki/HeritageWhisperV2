    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 h-full flex flex-col md:flex-row md:items-center gap-2 md:gap-0 pt-[14px] md:pt-2 py-1 md:py-0">
        ...
        <button
          ...
          style={{
            borderColor: "rgba(203, 164, 106, 0.3)",
            background: "rgba(203, 164, 106, 0.08)",
            color: "#CBA46A"
          }}
          ...
          <div className="relative">
            ...
            >
              ...
              <div
                ...
                style={{ background: "rgba(203, 164, 106, 0.15)" }}
              />

              {/* Progress fill - warm gold gradient */}
              <div
                className="absolute left-0 top-0 h-full rounded-full transition-all duration-200"
                style={{
                  width: `${progress}%`,
                  background: 'linear-gradient(135deg, rgba(203, 164, 106, 0.9) 0%, rgba(180, 140, 80, 0.9) 100%)',
                }}
              />
              ...
              {bookStructure.decades.map((decade) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      left: `${markerPosition}%`,
                      backgroundColor: 'rgba(203, 164, 106, 0.95)',
              ...
              {isHovering && (() => {
                ...
                return (
                  ...
                  >
                    ...
                    {year && <span style={{ color: "#CBA46A" }}> · {year}</span>}
                  </div>
                );
              })()}
            </div>
                    ...
                    >
                      ...
                      <div
                        style={{
                          width: '1px',
                          height: '6px',
                          background: 'linear-gradient(to bottom, rgba(203, 164, 106, 0.4), rgba(203, 164, 106, 0.15))',
                          margin: '0 auto 0px',
                        }}
                      />
                      {/* Date box */}
                      <button
                        ...
                        style={{
                          backgroundColor: 'rgba(203, 164, 106, 0.15)',
