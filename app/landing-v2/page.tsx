    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-rose-50 to-white overflow-x-hidden">
      ...
      <section className="min-h-screen relative flex items-center justify-center">
        <div className="relative z-10 flex flex-col items-center justify-center px-6 py-20">
          ...
          <button
            ...
            className="mb-6 px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-full text-xl md:text-2xl font-semibold hover:border-gray-400 hover:bg-gray-50 transition-all duration-300"
            style={{
              fontFamily: "Poppins, sans-serif",
      ...
      <section id="personalized" className="py-24 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="bg-gradient-to-r from-amber-500 to-rose-500 text-white px-8 py-4 rounded-full text-xl md:text-2xl font-semibold shadow-lg">
      ...
      <section
        id="reassurance"
        className="py-24 px-6 relative z-10 bg-gradient-to-br from-amber-50 via-yellow-50 to-white"
      >
        <div className="max-w-5xl mx-auto">
          <h2
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-center text-gray-800 mb-16 fade-up"
          ...
          <div
            className="bg-gradient-to-r from-amber-100 to-yellow-100 border-2 border-amber-200 rounded-3xl p-10 fade-up"
            style={{ transitionDelay: "600ms" }}
          >
            <h3
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <button
              onClick={() => router.push("/gift-plans")}
              className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white px-12 py-6 md:px-16 md:py-8 rounded-full text-2xl md:text-3xl shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 border-4 border-white"
              style={{ fontFamily: "Poppins, sans-serif", fontWeight: 700 }}
            >
              See Gift Plans
            </button>
