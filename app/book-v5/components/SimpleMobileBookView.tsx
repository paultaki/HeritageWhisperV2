...
export default function SimpleMobileBookView({
  ...
  return (
    <div className="lg:hidden relative h-[100dvh] w-screen overflow-hidden select-none">
      {/* Premium dark slate background - using brand primary */}
      <div className="absolute inset-0" style={{ background: `linear-gradient(to bottom, #1a2836 0%, #162230 50%, #1a2836 100%)` }} />
      ...
      <header className="absolute inset-x-0 top-0 z-40 flex items-center justify-between gap-3 px-4 pt-[env(safe-area-inset-top)] h-16">
        <div className="flex items-center gap-3 min-w-0">
          <div 
            ...
            style={{ 
              background: "rgba(32, 57, 84, 0.3)",
              '--tw-ring-color': "rgba(32, 57, 84, 0.5)",
              color: COLORS.page
            }}
          >
            {userInitials}
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            style={{
              background: "rgba(32, 57, 84, 0.2)",
              '--tw-ring-color': "rgba(32, 57, 84, 0.4)",
              color: COLORS.page
            }}
            aria-label="Edit"
          >
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 right-0 z-20 flex items-center justify-between px-2">
        <button
          ...
          style={{
            ...
            color: COLORS.page,
            '--tw-ring-color': "rgba(247, 242, 236, 0.3)"
          }}
          aria-label="Previous"
        >
...
// Story Page Component - with 120px bottom padding for mobile
function StoryPage({
  story,
  formatDate,
  fmtTime,
    ...
    >
      <div 
        ...
        style={{ 
          ...
          color: COLORS.text,
          '--tw-ring-color': "rgba(32, 57, 84, 0.1)"
        }}
      >
        {/* Subtle inner edge */}
        <div className="absolute inset-0 pointer-events-none shadow-[inset_0_1px_0_rgba(0,0,0,0.02),inset_0_-1px_0_rgba(0,0,0,0.02)]" />

        {/* Vertical scroller - with 120px bottom padding */}
        <div ref={scrollRef} className="relative h-full overflow-y-auto overscroll-contain book-v5-scroll book-v5-mobile-scroll-container">
          {/* Header image */}
          <div className="px-3 pt-4">
            <div
              className="overflow-hidden rounded-xl ring-1 shadow-sm relative cursor-pointer group book-v5-photo book-v5-photo-rotate-1"
              style={{ 
                aspectRatio: "4/3",
                background: "white",
          ...
          {/* Content - 120px bottom padding to clear nav */}
          <div className="px-5 pt-5 book-v5-mobile-content" style={{ paddingBottom: 'calc(120px + env(safe-area-inset-bottom, 0px))' }}>
            <h1 
            ...
            <div className="mt-1 text-[15px] book-v5-date">
            ...
            {/* Gold separator instead of purple underline */}
            <div className="mt-3 mb-4 h-px book-v5-separator" style={{ opacity: 0.5 }}></div>
            ...
            {/* Story Content */}
            <div className="mt-5 space-y-4 text-[19px] leading-8 font-serif" style={{ color: COLORS.text }}>
            ...
            {/* Wisdom/Lesson - with gold accent border */}
            {story.wisdomClipText && (
              <div className="book-v5-wisdom mt-6">
          ...
          {showFade && (
            <div 
              ...
              style={{ background: `linear-gradient(to top, ${COLORS.page} 0%, transparent 100%)` }}
            />
          )}
          {showContinueHint && (
...
// Audio Player Component - Minimalist with brand primary
function AudioPlayer({ audioUrl, fmtTime }: { audioUrl: string; fmtTime: (secs: number) => string }) {
  ...
  return (
    <div className="mt-5 book-v5-audio">
      <audio
        ref={audioRef}
        src={audioUrl}
        preload="metadata"
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="mt-1 flex justify-end book-v5-audio-time">
            <span>
...
// TOC Sheet Component - using brand tokens
function TOCSheet({
  decadeGroups,
  onClose,
  onStoryClick,
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="px-4 pb-4 space-y-6 max-h-[70dvh] overflow-y-auto overscroll-contain book-v5-scroll">
            {decadeGroups.map(([decade, stories]) => (
              <section key={decade} className="space-y-3">
                <h3 className="text-sm tracking-tight font-semibold" style={{ color: COLORS.text }}>{decade}</h3>
                <div 
                  className="divide-y rounded-xl ring-1 overflow-hidden"
                  style={{ 
                    background: "white",
                    '--tw-divide-color': COLORS.border,
                    '--tw-ring-color': COLORS.border
                  }}
                >
                  {stories.map((story) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-xs book-v5-date">
