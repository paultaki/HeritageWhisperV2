        ...
        <div className="bg-white rounded-lg shadow-sm p-8 prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-4">
              ...
              between you and Heritage Whisper LLC ("HeritageWhisper," "we,"
              "us," or "our"), a Washington limited liability company.
            </p>
            <p className="text-gray-700 mb-4">
              By accessing or using HeritageWhisper.com (the "Service"), you
            ...
            <ol className="space-y-2 text-gray-700">
              ...
              <li>
                <a href="#section-4" className="text-coral-600 hover:underline">
                  Your Content and Ownership Rights
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#section-7" className="text-coral-600 hover:underline">
                  Account Succession and Legacy Planning
                </a>
              </li>
              <li>
          ...
          <section id="section-1" className="mb-12">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">
              What HeritageWhisper Does
            </h3>
            <p className="text-gray-700 mb-4">
              HeritageWhisper is a voice recording and AI-powered storytelling
              platform designed to help families preserve life stories and
              memories. The Service includes:
            </p>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                ...
                <li>
                  AI-generated follow-up questions and insights (via GPT-4)
                </li>
            ...
            <p className="text-gray-700 mb-4">
              HeritageWhisper is currently available only to users in the United
              States. We do not offer services to residents of the European
              Union or United Kingdom.
            </p>
            <p className="text-gray-700">
              The Service requires internet access and is designed primarily for
              smartphone use, though it works on desktop browsers.
            </p>
          </section>
          ...
          <section id="section-2" className="mb-12">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
              ...
              <li>
                Users between 13-17 may use the Service only with verifiable
                parental consent, with the parent maintaining account control.
              </li>
              <li>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-4">
              ...
              <li>
                Your real name (for account security and succession planning)
              </li>
            </ul>
            ...
            <p className="text-gray-700">
              You may create only one account. Creating multiple accounts to
              circumvent free tier limitations or after account termination is
              prohibited.
            </p>
          </section>
          ...
          <section id="section-3" className="mb-12">
            ...
            <div className="mb-6 bg-blue-50 p-4 rounded-lg">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">
                Collaborative Features (Premium Only):
              </h3>
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                <li>Up to 5 family members (View Only or Collaborator)</li>
                <li>
                  Collaborators can add unlimited stories to shared timeline
                </li>
                <li>
                  Each collaborator needs their own free HeritageWhisper account
                </li>
                <li>
                  Collaborator accounts remain free even when contributing to
                  Premium timelines
                </li>
              </ul>
            </div>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                ...
                <li>
                  You may cancel before renewal if you disagree with new pricing
                </li>
              </ul>
            </div>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                <li>
                  If we offer a free trial, we'll clearly state terms before you
                  sign up
                </li>
                <li>
                  Credit card required; you'll be charged when trial ends unless
                  you cancel
                </li>
              </ul>
            </div>
            ...
            <p className="text-gray-700">
              Senior living communities or organizations should contact
              sales@heritagewhisper.com for bulk pricing and features.
            </p>
          </section>
          ...
          <section id="section-4" className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              4. Your Content and Ownership Rights
            </h2>
            ...
            <p className="text-gray-700 mb-2">
              <strong>Full ownership:</strong> You retain complete ownership and
              copyright of all:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              HeritageWhisper claims zero ownership of your content.
            </p>

            <h3 className="text-xl font-semibold text-gray-800 mb-4">
              Multi-Contributor Ownership
            </h3>
            ...
            <div className="mb-6 bg-amber-50 p-4 rounded-lg">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                ...
                <li>
                  If you delete your account, collaborators retain their stories
                </li>
                <li>
                  If a collaborator leaves, they choose whether their stories
                  remain
                </li>
              </ul>
            </div>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4 mt-8">
              What you CAN do as account owner:
            </h3>
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-6">
              <li>
                Remove collaborator access (but not delete their content without
                permission)
              </li>
              <li>Archive or hide collaborator stories from timeline view</li>
              <li>Change permission levels</li>
              <li>
                Export the full timeline including collaborator content (for
                backup)
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-6">
              <li>
                Delete stories created by collaborators (without their consent)
              </li>
            ...
            <p className="text-gray-700 mb-2">
              By uploading content, you grant HeritageWhisper a limited,
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-6">
              ...
              <li>
                Terminates when you delete content (except for backup retention
                periods)
              </li>
              <li>
                Does not allow us to use your content for marketing, training AI
                models, or any purpose beyond serving you
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-4">
              ...
              <li>
                Your content does not violate anyone else's intellectual
                property rights
              </li>
              <li>Your content does not violate any laws</li>
              <li>
                You have consent from any person identifiable in photos or
                recordings
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-6">
              ...
              <li>
                Obtaining necessary permissions from others featured in your
                content
              </li>
            </ul>
            ...
            <p className="text-gray-700">
              If you send us ideas, suggestions, or feedback about
              HeritageWhisper ("Feedback"), you grant us the right to use that
              Feedback without compensation or attribution. This does not apply
              to your personal stories—only to suggestions about the Service
              itself.
            </p>
          </section>
          ...
          <section id="section-5" className="mb-12">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-2">
                GPT-4 analyzes story text to generate:
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-700">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-6">
              ...
              <li>
                Transcriptions may contain errors, especially with accents,
                unclear speech, background noise, technical terms, or uncommon
                names
              </li>
              <li>
                All AI-generated content is subject to your review and editing
              </li>
            </ul>
            ...
            <p className="text-gray-700 mb-2">
              Your stories are NEVER used to:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-4">
            ...
            <p className="text-gray-700">
              All AI processing is ephemeral and conducted solely to serve you.
            </p>
          </section>
          ...
          <section id="section-6" className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              6. Family Sharing and Access Controls
            </h2>
            ...
            <p className="text-gray-700 mb-4">
              For complete details on collaboration features, content ownership
              rules, and managing collaborators, please see the full section in
              this document.
            </p>
          </section>
          ...
          <section id="section-7" className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              7. Account Succession and Legacy Planning
            </h2>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-4">
              <li>
                Email support@heritagewhisper.com with "Successor Designation"
              </li>
            ...
            <p className="text-gray-700 mb-6">
              You may change or remove your designated successor at any time.
            </p>

            <h3 className="text-xl font-semibold text-gray-800 mb-4">
              Successor Access Process
            </h3>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                <li>
                  Certified death certificate OR court order of incapacity
                </li>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                ...
                <li>
                  Continue Premium subscription (optional, at their expense)
                </li>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">
              Unclaimed Deceased Accounts
            </h3>
            <p className="text-gray-700 mb-2">
              If you die without designating a successor:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-700">
              <li>
                We preserve your account for 5 years after we're notified of
                your death
              </li>
              <li>
                Family members may claim access with proper legal documentation
              </li>
              <li>After 5 years, unclaimed accounts are permanently deleted</li>
              <li>
                We are not obligated to notify family members of account
                existence
              </li>
            </ul>
          </section>
          ...
          <section id="section-8" className="mb-12">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-4">
              You May NOT Use HeritageWhisper To:
            </h3>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                <li>
                  Invite collaborators for the purpose of exploiting or
                  manipulating them
                </li>
                <li>
                  Add false or defamatory content to someone else's timeline
                </li>
                <li>Use collaboration features to harass other contributors</li>
                <li>Coerce an account owner to grant you permissions</li>
                <li>
                  Delete or hide stories to destroy evidence of wrongdoing
                </li>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                <li>
                  Coerce elderly users to share stories they don't want to share
                </li>
                <li>Access accounts through exploitation or undue influence</li>
                <li>Delete or hide stories to erase evidence</li>
                <li>
                  Use the Service to facilitate elder abuse or exploitation
                </li>
              </ul>
            </div>
          ...
          <section id="section-9" className="mb-12">
            ...
            <p className="text-gray-700 mb-2">
              HeritageWhisper owns all rights to:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-4">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-6">
              ...
              <li>
                Third-party services we integrate with (OpenAI, Stripe, etc.)
              </li>
            </ul>
          ...
          <section id="section-10" className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              10. Service Management and Modifications
            </h2>
          ...
          <section id="section-11" className="mb-12">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 mb-6">
              ...
              <li>
                Premium subscriptions continue until the end of the paid period
                (no refunds)
              </li>
            </ul>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-2 uppercase font-bold">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-4 uppercase font-bold">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, OUR MAXIMUM LIABILITY TO
                YOU FOR ANY CLAIM IS LIMITED TO THE LESSER OF:
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                <li>
            ...
            <p className="text-gray-700 text-sm mt-6">
              ...
              limitation of liability for incidental damages. If you're in such
              a state, some limitations above may not apply, and you may have
              additional rights.
            </p>
          </section>
          ...
          <section id="section-13" className="mb-12">
            ...
            <p className="text-gray-700 mb-4">
              You agree to defend, indemnify, and hold harmless HeritageWhisper
              LLC and its officers, directors, employees, contractors, and
          ...
          <section id="section-14" className="mb-12">
            ...
            <p className="text-gray-700 mb-4">
              ...
              legal@heritagewhisper.com and attempt to resolve the dispute
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-4 mt-4">
              ...
              <p className="text-gray-700 uppercase font-bold">
                ...
                CLASS ACTION. YOU WAIVE THE RIGHT TO PARTICIPATE IN CLASS
                ACTIONS.
              </p>
            </div>
          </section>
          ...
          <section id="section-15" className="mb-12">
            ...
            <p className="text-gray-700 mb-6">
              ...
              entire agreement between you and HeritageWhisper regarding the
              Service.
            </p>
            ...
            <p className="text-gray-700 mb-6">
              You may NOT assign these Terms or your account to anyone else. We
            ...
            <p className="text-gray-700">
              ...
              that provision is severed from the Terms, and the remaining
          ...
          <section id="section-16" className="mb-12">
            ...
            <p className="text-gray-700">
              If you continue using the Service after changes take effect, you
            ...
            <div className="space-y-4 text-gray-700">
              <div>
                ...
                <p>
                  Email:{" "}
                  <a
                    href="mailto:legal@heritagewhisper.com"
                    className="text-coral-600 hover:underline"
                  >
                    legal@heritagewhisper.com
                  </a>
                </p>
                <p>
                  Mail: Heritage Whisper LLC, 522 W Riverside Ave, Suite N,
              ...
              <p className="text-sm">
                We respond to legal inquiries within 5-7 business days.
              </p>
            </div>
          </section>
          ...
          <div className="mt-12 bg-red-50 border-l-4 border-red-400 p-6">
            <p className="text-gray-700 font-semibold uppercase">
              BY USING HERITAGEWHISPER, YOU ACKNOWLEDGE THAT YOU HAVE READ,
          ...
          <section className="mt-12 pt-8 border-t border-gray-200">
            ...
            <p className="text-gray-600 text-sm mt-2">
              Heritage Whisper LLC reserves the right to update these Terms.
